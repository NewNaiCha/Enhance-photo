...
一个给 Codex / Skill 场景用的修图技能。

它做的不是单纯“帮我润色提示词”，而是把一张参考图片先做题材判断，再匹配更合理的摄影参数，最后生成适合该场景的中文增强 / 重建提示词；如果图片是人像，还会额外走严格保身份分支。
...
这个仓库当前公开的是 skill 本体和参考模板，方便直接查看、复用和继续迭代。
